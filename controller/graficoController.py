...
#   Primeira Página    
        ...
        c.drawString(570, 10, '1')

    def pdfPag2(self, c, diretorio):
#   Segunda Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '2')

    def pdfPag3(self, c, diretorio):
#   Terceira Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '3')

    def pdfPag4(self, c, diretorio):
#   Quarta Página    
...
#        c.drawString(30, 250,"Obrigações formais")
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '4')

    def pdfPag5(self, c, diretorio):
#   Quinta Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '5')

    def pdfPag6(self, c, diretorio):
#   Sexta Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '6')

    def pdfPag7(self, c, diretorio):
#   Setima Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '7')
 
    def pdfPag8(self, c, diretorio):
#   Oitava Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '8')

    def pdfPag9(self, c, diretorio):
#   Nona Página    
        ...
        c.setFont('Helvetica', 10)
        c.drawString(570, 10, '9')

    def montaDir(self, idEmpreend, mes, ano):
